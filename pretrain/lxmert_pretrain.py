...
from baseline.lxmert.pretrain.lxmert_data import InputExample, LXMERTDataset, \
    LXMERTTorchDataset, LXMERTEvaluator
from baseline.lxmert.lxrt.entry import set_visual_config
from baseline.lxmert.lxrt.tokenization import BertTokenizer
from baseline.lxmert.lxrt.modeling import LXRTPretraining
...
class LXMERT:
    ...
    def train(self, train_tuple: DataTuple, eval_tuple: DataTuple):
        ...
        # Optimizer
        from baseline.lxmert.lxrt.optimization import BertAdam
