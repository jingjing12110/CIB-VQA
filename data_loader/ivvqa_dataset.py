...
class IVVQADataset(Dataset):
    def __init__(self, args, test_mode='edited'):
        ...
        # Loading dataset
        self.data = load_json(f'data/iv_vqa/{test_mode}_targets.json')
        
        # Loading detection features to img_data
        if test_mode == 'edited':
            self.obj_h5 = h5py.File('data/iv_vqa/iv_vqa_obj36.h5', 'r')
            for d in self.data:
...
class IVVQAVLTransDataset(IVVQADataset):
    def __init__(self, args, test_mode='edited'):
        ...
        self.que_dp = h5py.File(
            f"data/iv_vqa/vqa_rep_que_dp_roberta.h5", 'r')

        self.obj_graph = h5py.File(f'data/iv_vqa/iv_vqa_img2graph.h5', 'r')
...
class IVVQAUNITERDataset(Dataset):
    def __init__(self, args, test_mode='edited'):
        super().__init__()
        self.args = args
        self.test_mode = test_mode 
...
class IVVQAViLBERTDataset(Dataset):
    def __init__(self, args, test_mode='edited'):
        super().__init__()
        self.args = args
        self.test_mode = test_mode
...
class IVVQAOSCARDataset(Dataset):
    def __init__(self, args, test_mode='edited'):
        super().__init__()
        self.args = args
        self.test_mode = test_mode
