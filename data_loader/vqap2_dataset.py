...
class VQAP2Dataset(Dataset):
    def __init__(self, args):
        super().__init__()
        self.args = args
        
        self.data_p2 = load_json(f'data/vqa_p2/vqa_p2_targets.json')
        self.data_ori = load_json(f'data/vqa_p2/vqa_p2_original_targets.json')
        self.data = self.data_p2 + self.data_ori
...
class VQAP2VLTransDataset(VQAP2Dataset):
    def __int__(self, args, test_mode):
        super(VQAP2VLTransDataset, self).__init__(args)
        self.que_dp = h5py.File(
            f"data/vqa_p2/{test_mode}_que_dp_roberta.h5", 'r')
...
class VQAP2UNITERDataset(Dataset):
    def __init__(self, args):
        super().__init__()
        self.args = args
...
class VQAP2ViLBERTDataset(Dataset):
...
class VQAP2OSCARDataset(Dataset):
    def __init__(self, args):
        super().__init__()
        self.args = args
