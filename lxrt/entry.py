...
from .modeling import LXRTFeatureExtraction as VisualBertForLXRFeature
from .modeling import VISUAL_CONFIG
...
class LXRTEncoderFeature(nn.Module):
    """modify in X-GGM for outputting feature sequences"""
